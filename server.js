// PONTE LOGISTICO v4 — banner di verifica: VERSIONE-PANNELLI-SI-NO
// se Render non mostra i pannelli, questo file non e' quello caricato.
...
app.listen(PORT, "0.0.0.0", () => {
  console.log("VERSIONE-PANNELLI-SI-NO attiva sulla porta " + PORT);
});
