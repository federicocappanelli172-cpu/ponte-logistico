...
<div class="modal-bg" id="modalBg">
  <div class="modal">
    ...
    <label>Quando parte</label>
    <input id="fWhen" placeholder="es. oggi 15:30">
  ...
  t.items.forEach(item => {
    ...
    card.innerHTML = \`
      ...
      <div class="btns">
        ...
        <span class="counts"><span>✅ <b>\${joins.length}</b> \${joins.map(v=>esc(v.who)).join(", ")||"—"}</span>
        <span>❌ <b>\${skips.length}</b></span></span>
      </div>\`;
